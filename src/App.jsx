...
const App = () => {
        ...
        },
    {
        ...
        //barcelona
        {
            title: "Espanya o Spain: Karanasan at Pamumuhay - Barcelona",
        ...
        {
            title: "Philippines (Agosto 1887) - Manila",
            text:"Matapos ang ilang taong pananatili sa Europa, bumalik si Dr. José Rizal sa Pilipinas noong Agosto 1887. Kahit marami ang nagbabala sa kanya na huwag na siyang bumalik dahil sa kontrobersiyang dulot ng Noli Me Tangere, nanaig pa rin ang kanyang kagustuhang operahan ang mata ng kanyang ina, maglingkod sa mga kababayan, alamin ang epekto ng kanyang nobela, at malaman ang dahilan ng pananahimik ni Leonor Rivera. Mula Rome, bumiyahe siya patungong Marseilles sakay ng tren. Noong Hulyo 3, 1887, sumakay siya sa Djemnah, ang pareh ong barkong sinakyan niya noong una niyang paglalakbay, at muling nadaanan ang Suez Canal. Pagdating sa Saigon noong Hulyo 30, lumipat siya sa barkong Haiphong na patungong Maynila. Umalis ito noong Agosto 2, at dumating si Rizal sa Maynila pagsapit ng hatinggabi ng Agosto 5, 1887. Sa lungsod, nanatili siya ng ilang araw upang dumalaw sa mga kaibigan. Sa kanyang pagmamasid, tila walang nagbago sa Maynila. Ang mga lumang gusali, simbahan, at mga bangka sa Ilog Pasig ay gaya pa rin ng kanyang iniwan. Ngunit sa kabila ng tila katahimikan, dama niya ang tensyon na dulot ng kanyang pagbabalik, lalo na mula sa mga kalaban ng reporma.",
            layers: [
        ...
        {
            title: "Philippines (Agosto 1887) - Calamba",
            text:"Noong Agosto 8, nagtungo si Rizal sa kanyang bayan sa Calamba, kung saan mainit siyang sinalubong ng kanyang pamilya. Dito, nagtayo siya ng klinika at matagumpay na inoperahan ang mata ng kanyang ina. Tinawag siyang “Dr. Uliman” dahil sa kanyang pag-aaral sa Alemanya. Bukod dito, nagtayo rin siya ng gymnasium para sa mga kabataan. Ngunit hindi rin siya nakaligtas sa mga tsismis at paninira. Pinaratangan siyang German spy, Mason, at Protestanteng nagtataguyod ng mga mapanirang ideya. Dahil dito, palagi siyang sinasamahan ni Paciano para sa kanyang kaligtasan. Dahil na rin sa reklamo ng mga prayle, ipinatawag siya ni Gobernador-Heneral Emilio Terrero, ngunit walang sapat na ebidensyang makakapagpataw ng kaso sa kanya. Bagamat ipinagbawal ang nobela, patuloy itong binabasa nang palihim ng mga Pilipino. Sa kabila ng lahat, nagpatuloy si Rizal sa kanyang paninindigan at pamumuhay sa Calamba bilang isang doktor, guro, at tagapagtanggol ng kanyang mga kababayan.",
            layers: [
                { src: bgp3, speed: -0.2, mouseSpeed: -0.01, objectFit: 'cover', position: 'top center', z: -2},
                { src: mg2p3, speed: -0.6, mouseSpeed: -0.02, objectFit: 'cover', position: 'center', z: -1, size: '100% auto' },
                { src: mgp3, speed: -0.6, mouseSpeed: -0.04, objectFit: 'cover', position: 'center', z: 10, size: '100% auto' },
        ...
        
        {
            ...
            text:"Noong 1896 sa Maynila, si José Rizal ay naaresto dahil sa kanyang mga gawa at paninindigan laban sa kolonyal na pamahalaan ng Espanya. Matapos ang isang mabilis na paglilitis, siya ay hinatulan ng kamatayan. Sa Disyembre 30, 1896, siya ay binitay sa pamamagitan ng firing squad, isang pangyayaring nagbigay inspirasyon at nagpaalab sa damdamin ng mga Pilipino para sa kalayaan.",
            layers: [
                { src: phbg, speed: -0.2, mouseSpeed: -0.01, objectFit: 'cover', position: 'bottom center', z: -5, size: '200% auto'},
                { src: phmg1, speed: -0.6, mouseSpeed: -0.02, objectFit: 'cover', position: 'center', z: -4, size: '100% auto' },
                { src: phmg2, speed: -0.6, mouseSpeed: 0.02, objectFit: 'cover', position: 'bottom center', z: -3, size: '100% auto' },
